...
<section class="visi-misi">
    <div class="container">
        <div class="row">
            <div class="col">
                <h2>Visi</h2>
                <p>Masyarakat Bone Mandiri, Berdaya, Saing dan Sejahtera.
                </p>
                <h2>Misi</h2>
                <ol>
                    <li>Meningkatkan tata kelola pemerintah yang baik, bersih dan bebas Korupsi, Kolusi, dan Nepotisme (KKN).</li>
                    <li>Mengembangkan kemandirian ekonomi dan meningkatkan taraf hidup masyarakat.</li>
                    <li>Meningkatkan akses, pemerataan dan kualitas pelayanan kesehatan, pendidikan dan sosial dasar lainnya.</li>
                    <li>Mengoptimalkan akselerasi pembangunan daerah berbasis desa dan kawasan perdesaan.</li>
                    <li>Mendorong penciptaan iklim investasi yang kondusif untuk pengembangan usaha dan mengembangkan inovasi daerah dalam peningkatan pelayanan publik.</li>
                    <li>Meningkatkan budaya politik, penegakan hukum dan seni budaya dalam kemajemukan masyarakat.</li>
                </ol>
                </div>
            </div>
        </div>
