...
<head>
  ...
  <title>Dinas Pendidikan Kab. Bone | Data Pegawai</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Staff Pegawai</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add Staff Pegawai</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020 <a href="#">Dinas Pendidikan Kab. Bone</a>.</strong> All rights reserved.
  </footer>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xmapel" class="form-control" id="inputUserName" placeholder="Masukkan Jabatan" required>
                                        </div>
                                    </div>
