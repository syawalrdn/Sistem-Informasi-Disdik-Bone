...
<head>
  ...
  <title>Dinas Pendidikan Kab. Bone | Pengumuman</title>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="inputUserName" class="col-sm-4 control-label">Nama Pengumuman</label>
                                <div class="col-sm-7">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                  ...
                                  <input type="text" name="xnama_agenda" class="form-control" value="<?php echo $agenda_nama;?>" id="inputUserName" placeholder="Nama Pengumuman" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputUserName" class="col-sm-4 control-label">Deskripsi</label>
